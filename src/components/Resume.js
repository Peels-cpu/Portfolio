    ...
    return ( 
        <div className="App-header">
            <div className="AboutContainer">
                ...
                <hr />
                <div className="">
                <h4>Collections Agent for Bell Company(Affinity Global) </h4>
                    <small>December-2016 June-2017</small>
                    <p>Location: Markham ON Denison Street</p>
                    <ul>
                        <h3>Tasks</h3>
                        <li>Responsibilities include making 100 outbound calls and receiving inbounds</li>
                        <li>Documenting Customers Accounts, Requests and statuses</li>
                        <li>Collection of debt that is been previously owed</li>
                        <li>Meeting a quota in the month</li>
                        <li>Transferring calls to appropriate departments</li>
                        <li>Informing clients of consequences of their account if applicable</li>
                        <li>Cooperating with your team in order to process the best customer service</li>
                        <li>Reporting to manger(s) if needed to resolve problems and to discuss customer related issues</li>
                        <li>Multitasking between talking on the phone and completion of reports, documenting conversation on computer</li>
                    </ul>
                </div>
                <hr />
                <div className="">
